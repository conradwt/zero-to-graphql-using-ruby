...
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name zero_ruby zero_ruby
...
LABEL org.opencontainers.image.url=https://hub.docker.com/repository/docker/conradwt/zero-to-graphql-using-ruby
